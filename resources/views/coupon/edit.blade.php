...
@section('main')
 ...
 <div class="row">
  <div class="col col-lg-8 col-md-8 col-xs-12 col-sm-12">
   <div class="row">
    <div class="col col-12">
     <form action="{{route('coupon_update',['id'=>$model->id])}}" method='POST' class='coupon-form'>
      @csrf
      @method('PUT')
      <div class="row">
       <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
        <label for="" class="block">Coupon name</label>
        <input type="text" name='name' class='form-control control-block' value='{{$model->name}}'>
       </div>
       ...
       <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
        ...
        <select name="type" class="form-control control-block">
         ...
         @foreach(['amount','percent'] as $type)
          @php
           $selected=$type==$model->type?"selected='selected'":null;
          @endphp
      ...
      <div class="row">
        <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
         ...
         <input type="text" name='amount' class='form-control control-block' value="{{$model->amount}}">
        </div>

        <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
         <label for="" class="block">Coupon start date</label>
         <input type="text" name='sdate' class='form-control control-block sdate' value='{{$model->sdate}}' placeholder='select start date...'>
        </div>
      ...
      <div class="row">
        <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
         ...
         <input type="text" name='edate' class='form-control control-block edate' value='{{$model->edate}}' placeholder='select end date...'>
        </div>

        <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
         <label for="" class="block">Coupon minimum total</label>
         <input type="text" name='min_total' class='form-control control-block' value='{{$model->min_total}}'>
        </div>
      ...
      <div class="row">
        <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
         ...
         <input type="text" name='max_usage' class='form-control control-block' value='{{$model->max_usage}}'>
        </div>
      </div>
