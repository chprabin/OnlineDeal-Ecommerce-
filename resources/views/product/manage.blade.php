...
@section('main')
 <div class="row">
  <div class="col col-12">
   <h1 class="no-margin no-bold">Products management</h1>
  </div>
 </div>
 <div class="row">
  <div class="col col-12">
   <a href="{{route('product_create')}}" class="btn"><i class="fa fa-plus"></i> Create new product</a>
  </div>
  <div class="col col-12">
  ...
  <div class="col col-12">
   <div class="data">
    <div class="updatable-view">
     @include('product.manage-list',['data'=>$data])   
    </div>
   </div>
  </div>
 </div>
