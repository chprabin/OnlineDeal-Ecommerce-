...
@section('main')
 <div class="row">
  <div class="col col-12">
   <h1 class="no-margin no-bold">Create category</h1>
  </div>
 </div>
 <div class="row">
  <div class="col col-12">
   <div class="image-preview category-image-preview">
    <p>image will be displayed here on upload..</p>
   </div>
  </div>
 </div>
 <div class="row">
  <div class="col col-lg-8 col-md-8 col-xs-12 col-sm-12">
   <form action="{{route('category_save')}}" method='POST' class='category-form'>
    @csrf
    <div class="row">
     ...
     <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
      ...
      <input type="text" class='form-control control-block' name='showname'>
     </div>
    </div>
    <div class="row">
     <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
      ...
      <div class="selectable-list">
       <div class="control">
        <input type="hidden" name='parentId' class='main-input'>
        <div class="selected-item">select a category...</div>
    ...
    <div class="row">
     <div class="col col-lg-6 col-md-6 col-xs-12 col-sm-12">
      ...
      <a href="{{route('category_filters',['wm'=>1,'wselect'=>1, 'view'=>'filters', 'ws'=>1])}}"
